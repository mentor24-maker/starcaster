...
function buildPrompt(input) {
  ...
  return [
    ...
    '- At most 1 candidate may be neutral/context-first with no explicit project mention.',
    '- At least 2 candidates should subtly reflect the shared project framing when it naturally fits.',
    '- At least 2 candidates should make a light explicit reference to ISITAS, the ISIT Construct, or the ISIT Game when the post meaningfully overlaps those ideas.',
    'Constraints:',
    '- Plain text only.',
    ...
    '- Aim for about 50% of the candidates to include a light explicit ISITAS-related reference and only about 10% to be purely generic/context-first.',
