...
function tableConfig() {
  ...
  return {
    ...
    developModuleClasses  : resolve('SUPABASE_DEVELOP_MODULE_CLASSES_TABLE', 'develop_module_classes_table', 'develop_module_classes'),
    developModules        : resolve('SUPABASE_DEVELOP_MODULES_TABLE', 'develop_modules_table', 'develop_modules'),
    developPollSubmissions: resolve('SUPABASE_DEVELOP_POLL_SUBMISSIONS_TABLE', 'develop_poll_submissions_table', 'develop_poll_submissions'),
    ...
    developSavedSections  : resolve('SUPABASE_DEVELOP_SAVED_SECTIONS_TABLE', 'develop_saved_sections_table', 'develop_saved_sections'),
    developProducts       : resolve('SUPABASE_DEVELOP_PRODUCTS_TABLE', 'develop_products_table', 'develop_products'),
    ...
    developIcons        : resolve('SUPABASE_DEVELOP_ICONS_TABLE', 'develop_icons_table', 'develop_icons'),
