...
function tableConfig() {
  ...
  return {
    ...
    xHarvestRuns        : resolve('SUPABASE_X_HARVEST_RUNS_TABLE', 'x_harvest_runs_table', 'x_harvest_runs'),
    redditHarvestRuns   : resolve('SUPABASE_REDDIT_HARVEST_RUNS_TABLE', 'reddit_harvest_runs_table', 'reddit_harvest_runs'),
    ...
    personaHarvests     : resolve('SUPABASE_PERSONA_HARVESTS_TABLE', 'persona_harvests_table', 'influencer_persona_harvests'),
