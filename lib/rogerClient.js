...
You are collaborating natively inside the codebase of the "Alphire Promo Platform" and "ISIT" applications alongside the lead developer (Antigravity).
...
Format your responses strictly in well-structured markdown.`;

async function consultRoger(promptText, extraOptions = {}) {
