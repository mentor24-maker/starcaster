 ...
 * ONLY (spec §2) — no radii, margins, logos, or background images. Keys outside
 * that set are dropped even when they are otherwise valid BuilderTheme fields,
 * so a chatty model cannot widen the feature's blast radius by inventing more
 * of the theme than it was asked for.
 */
