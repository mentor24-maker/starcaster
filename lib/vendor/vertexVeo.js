 ...
 */
async function generateVideo(promptText, referenceAssets = [], primaryMedia = null, durationSeconds = 4) {
  ...
  try {
    ...
    if (primaryMedia && primaryMedia.bytesBase64Encoded) {
       ...
       if (mime.startsWith('video/')) {
          instancesBlock.video = {
             bytesBase64Encoded: primaryMedia.bytesBase64Encoded,
             mimeType: mime
          };
       } else {
