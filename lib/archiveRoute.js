...
/**
 * One spelling of a path for comparing names. Unicode has two ways to write a
 * letter like "Ç" (one code point, or "C" plus a combining mark), and disks and
 * Drive do not agree on which one they hand back — so a name read back is
 * compared in one form, never byte for byte (ticket 86bc4x5wh: 284 macOS
 * screenshots, whose names carry U+202F, read as "not on Drive").
 */
function nameKey(p) {
