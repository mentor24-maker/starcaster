...
const FORMAT_REGISTRY = {
  ...
  keyword: {
    ...
    label: 'Keyword',
    family: FAMILY.SUPPORT,
    contentField: 'keyword',
    isLongform: false,
    aiDescriptor: 'SEO keyword phrases (1 to 4 words each, one per line, lowercase, nothing else)',
  },
  tag: {
    slug: 'tag',
    label: 'Tag',
    ...
    contentField: 'tag',
    isLongform: false,
    aiDescriptor: '5 to 10 plain content tags (1 word preferred, max 3 words per tag with spaces between words, Title Case, no # symbols, one per line)',
  },
  cta: {
    slug: 'cta',
