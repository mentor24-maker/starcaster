 ...
 *
 * One table, two vocabularies. `messagingTagsStore` runs every tag through
 * `normalizeMessagingTag`, which title-cases and keeps at most THREE words —
 * right for hashtag-shaped messaging tags, wrong for media tags, where
 * "Center Court North Entrance" is a reasonable thing to type and would come
 * back as "Center Court North". Media tags keep the casing the admin typed and
 * are only trimmed and whitespace-collapsed, exactly as they were before.
 *
