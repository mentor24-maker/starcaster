...
const NOTICEBOARD_NAMES = [
  // Every name the team chat has had: until the first post from new code
  // renames it, the ticket still reads "Undelivered alarms", and an
  // unexcluded noticeboard reads as a ticket that shipped (task 86bc0mmyu).
  ...busFallback.ALL_TASK_NAMES,
