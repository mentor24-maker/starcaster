...
const API_SCHEMAS = {
  supabase: {
    ...
    fields: [
      ...
      { key: 'messaging_categories_table', label: 'Messaging Topics Table', required: false, secret: false },
...
function getProviderEnvValues(provider) {
  ...
  if (key === 'supabase') {
    ...
    out.messaging_categories_table = firstEnvValue(['SUPABASE_MESSAGING_CATEGORIES_TABLE']);
