 ...
 *   const limited = checkLimit(req, res, 'harvest.youtube');
...
const LIMITS = {
  ...
  'harvest.youtube': {
    max:      10,
    windowMs: 60 * 1000,          // 10 YouTube harvests / minute
  },
  'harvest.youtube.rerun': {
    max:      5,
    windowMs: 60 * 1000,          // 5 reruns / minute
  },
  'harvest.direct': {
    max:      20,
    windowMs: 60 * 1000,          // 20 direct harvests / minute
  },
 ...
 * @param   {string}  limitKey - Key from LIMITS (e.g. 'harvest.youtube', 'global')
