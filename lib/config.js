...
const SCHEMA = {
  ...
  vercelToken: {
    ...
    description: 'Vercel personal access token (used to read/write env vars via API)',
    secret: true,
    group: 'Vercel',
  },
  vercelProjectId: {
  ...
  cronSecret: {
    env: 'CRON_SECRET',
    description: 'Bearer secret for manual cron endpoint calls (Vercel Cron also sends this when set)',
    secret: true,
    group: 'Vercel',
  },
};
 ...
 * Requires VERCEL_API_TOKEN and VERCEL_PROJECT_ID to be set.
 *
