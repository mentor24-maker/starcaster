...
function createXHarvestRun(input, result, scope = null) {
...
function listXHarvestRuns(limit = 20, scope = null) {
...
function getXHarvestRun(runId, scope = null) {
...
function deleteXHarvestRun(runId, scope = null) {
  const id = String(runId || '').trim();
  if (!id) return { ok: false, status: 400, error: 'run_id is required' };
  const store = readStore();
