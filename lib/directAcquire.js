...
function buildContactLabels(summary) {
  ...
  const labels = [
    ...
    ['Emails', Array.isArray(summary.emails) ? summary.emails.join(', ') : ''],
    ['Phones', Array.isArray(summary.phones) ? summary.phones.join(', ') : ''],
    ['YouTube', Array.isArray(summary.youtube) ? summary.youtube.join(', ') : ''],
    ['Instagram', Array.isArray(summary.instagram) ? summary.instagram.join(', ') : ''],
    ['TikTok', Array.isArray(summary.tiktok) ? summary.tiktok.join(', ') : ''],
    ['Facebook', Array.isArray(summary.facebook) ? summary.facebook.join(', ') : ''],
    ['X', Array.isArray(summary.x) ? summary.x.join(', ') : ''],
    ['Bluesky', Array.isArray(summary.bluesky) ? summary.bluesky.join(', ') : ''],
    ['LinkedIn', Array.isArray(summary.linkedin) ? summary.linkedin.join(', ') : ''],
    ['Patreon', Array.isArray(summary.patreon) ? summary.patreon.join(', ') : ''],
    ['Substack', Array.isArray(summary.substack) ? summary.substack.join(', ') : ''],
    ['Medium', Array.isArray(summary.medium) ? summary.medium.join(', ') : ''],
    ['Telegram', Array.isArray(summary.telegram) ? summary.telegram.join(', ') : ''],
    ['Discord', Array.isArray(summary.discord) ? summary.discord.join(', ') : ''],
    ['WhatsApp', Array.isArray(summary.whatsapp) ? summary.whatsapp.join(', ') : ''],
  ];
