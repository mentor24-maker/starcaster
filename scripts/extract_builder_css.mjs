#!/usr/bin/env node
/**
 * Extract the Builder-related rules from normie's app/globals.css into
 ...
 *
 * Re-run after pulling builder UI changes from normie:
 *   node scripts/extract_builder_css.mjs [path-to-normie-globals.css]
 */
...
const source = process.argv[2] || path.resolve(root, '..', 'normie', 'app', 'globals.css');
...
const banner = `/*\n * GENERATED by scripts/extract_builder_css.mjs — do not edit by hand.\n * Source: ${path.relative(root, source)}\n */\n`;
