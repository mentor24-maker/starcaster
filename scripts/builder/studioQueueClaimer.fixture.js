...
// Start barrier: both processes are already open and warm, so the claiming
// itself overlaps rather than the process startup.
const startAt = Number(startAtRaw) || 0;
while (startAt && Date.now() < startAt) { /* spin — deliberately, it is milliseconds */ }
