...
App.els = {
  ...
  assetsBulkResizeBtn: document.getElementById('assetsBulkResizeBtn'),
  assetsBulkDeleteBtn: document.getElementById('assetsBulkDeleteBtn'),
  assetsBulkResizePanel: document.getElementById('assetsBulkResizePanel'),
  bulkResizeWidth: document.getElementById('bulkResizeWidth'),
  bulkResizeHeight: document.getElementById('bulkResizeHeight'),
  bulkResizeFit: document.getElementById('bulkResizeFit'),
  ...
  settingsProjectFaviconChooseBtn: document.getElementById('settingsProjectFaviconChooseBtn'),
  settingsProjectFaviconUploadFile: document.getElementById('settingsProjectFaviconUploadFile'),
  settingsProjectFaviconClearBtn: document.getElementById('settingsProjectFaviconClearBtn'),
  settingsProjectFaviconPreview: document.getElementById('settingsProjectFaviconPreview'),
  settingsProjectFaviconPlaceholder: document.getElementById('settingsProjectFaviconPlaceholder'),
  ...
  builderPagesForm: document.getElementById('builderPagesForm'),
...
function normalizeInitialPageId(pageId) {
  const id = String(pageId || '').trim();
  if (!id) return '';
  if (id === 'builderPagesPage') return 'builderManagePagesPage';
...
App.ACTION_ICONS = {
  ...
  restore: '<path d="M2 5a2 2 0 0 1 2-2h6l4 4v13a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5Z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M10 3v4h4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M5 12h6M5 16h4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M15 5l2-3M17 8h3M15 11l2 3" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>',
  ...
  harvest: '<path d="M8 4h8l4 4v8l-4 4H8l-4-4V8z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/><path d="M2 12h20M12 2v20M4 4l16 16M4 20L20 4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>',
  stacked: '<path d="M4 6h16M4 12h16M4 18h16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>',
};
