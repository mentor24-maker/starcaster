...
App.pageHeadingNav = (function pageHeadingNavModule() {
  const CLICK_HANDLERS = {
    ...
    builder.openThemesPage': () => App.builder?.openThemesPage?.(),
    builder.openAgentsPage': () => App.builder?.openAgentsPage?.(),
    builder.openManageLandingPages': () => App.setActivePage('builderManageLandingPagesPage'),
