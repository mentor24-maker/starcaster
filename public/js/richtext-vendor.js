var TipTapBundle = (() => {
  ...
  // public/js/richtext-vendor-entry.js
  var richtext_vendor_entry_exports = {};
  __export(richtext_vendor_entry_exports, {
    Editor: () => Editor,
    Link: () => index_default,
    StarterKit: () => index_default3,
    TextAlign: () => index_default4,
    Underline: () => index_default2
  });
...
${nextLine.slice(indentLevel + 2)}`;
  ...
  return __toCommonJS(richtext_vendor_entry_exports);
})();
