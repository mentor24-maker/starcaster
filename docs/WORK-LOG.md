...
page list is still there. Three module settings can only be reached through it
until the module piece of this work is live, and taking it away first would
make them unreachable on pages that use them.
