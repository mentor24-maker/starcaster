...
--
-- Name: set_events_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: blog_post_relations; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE "public"."events" (
    ...
    "location_url" "text" DEFAULT ''::"text" NOT NULL,
    "organizer_name" "text" DEFAULT ''::"text" NOT NULL,
    "organizer_contact" "text" DEFAULT ''::"text" NOT NULL,
    "seo_title" "text" DEFAULT ''::"text" NOT NULL,
    "seo_description" "text" DEFAULT ''::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
...
--
-- Name: project_bug_reports; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."project_bug_reports" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "project_id" "text" NOT NULL,
    "owner_user_id" "text",
    "description" "text" NOT NULL,
    ...
    "viewer_tier" "text" DEFAULT 'public'::"text" NOT NULL,
    "screenshot_asset_ids" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "status" "text" DEFAULT 'new'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "project_bug_reports_status_check" CHECK (("status" = ANY (ARRAY['new'::"text", 'forwarded'::"text", 'failed_forward'::"text"]))),
    CONSTRAINT "project_bug_reports_viewer_tier_check" CHECK (("viewer_tier" = ANY (ARRAY['public'::"text", 'client'::"text", 'staff'::"text"])))
);

--
-- Name: project_connection_handoffs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."project_connection_handoffs" (
    "id" "text" NOT NULL,
    "project_id" "text" NOT NULL,
    "owner_user_id" "text",
    "user_id" "text" NOT NULL,
...
CREATE TABLE "public"."project_connections" (
    ...
    "refresh_token_iv" "text" DEFAULT ''::"text" NOT NULL,
    "refresh_token_tag" "text" DEFAULT ''::"text" NOT NULL,
...
--
-- Name: blog_post_relations blog_post_relations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: project_bug_reports project_bug_reports_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."project_bug_reports"
    ADD CONSTRAINT "project_bug_reports_pkey" PRIMARY KEY ("id");

--
-- Name: project_connection_handoffs project_connection_handoffs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."project_connection_handoffs"
    ADD CONSTRAINT "project_connection_handoffs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."project_connections"
    ADD CONSTRAINT "project_connections_pkey" PRIMARY KEY ("project_id", "provider", "account_id");
...
--
-- Name: idx_asset_tags_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_asset_tags_project_id" ON "public"."asset_tags" USING "btree" ("project_id");

--
-- Name: idx_asset_tags_project_tag; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "idx_asset_tags_project_tag" ON "public"."asset_tags" USING "btree" ("project_id", "lower"("tag"));
...
--
-- Name: idx_assets_project_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_assets_project_source" ON "public"."assets" USING "btree" ("project_id", "source");
...
--
-- Name: idx_blog_post_relations_pair_project; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "idx_blog_post_relations_pair_project" ON "public"."blog_post_relations" USING "btree" ("project_id", "post_id_a", "post_id_b");

--
-- Name: idx_blog_post_relations_post_a; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_blog_post_relations_post_a" ON "public"."blog_post_relations" USING "btree" ("project_id", "post_id_a");

--
-- Name: idx_blog_post_relations_post_b; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_blog_post_relations_post_b" ON "public"."blog_post_relations" USING "btree" ("project_id", "post_id_b");

--
-- Name: idx_blog_post_relations_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_blog_post_relations_project_id" ON "public"."blog_post_relations" USING "btree" ("project_id");
...
--
-- Name: idx_events_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_events_project_id" ON "public"."events" USING "btree" ("project_id");

--
-- Name: idx_events_slug_project; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "idx_events_slug_project" ON "public"."events" USING "btree" ("project_id", "slug") WHERE ("slug" <> ''::"text");

--
-- Name: idx_events_starts_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_events_starts_at" ON "public"."events" USING "btree" ("project_id", "starts_at");

--
-- Name: idx_events_status_project; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_events_status_project" ON "public"."events" USING "btree" ("project_id", "status");
...
--
-- Name: idx_project_bug_reports_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_bug_reports_project_id" ON "public"."project_bug_reports" USING "btree" ("project_id");

--
-- Name: idx_project_bug_reports_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_bug_reports_status" ON "public"."project_bug_reports" USING "btree" ("status");

--
-- Name: idx_project_connection_handoffs_expires; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_connection_handoffs_expires" ON "public"."project_connection_handoffs" USING "btree" ("expires_at");

--
-- Name: idx_project_connection_handoffs_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_connection_handoffs_project_id" ON "public"."project_connection_handoffs" USING "btree" ("project_id");

--
-- Name: idx_project_connections_expires_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_connections_expires_at" ON "public"."project_connections" USING "btree" ("expires_at");

--
-- Name: idx_project_connections_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_connections_project_id" ON "public"."project_connections" USING "btree" ("project_id");

--
-- Name: idx_project_connections_project_provider; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "idx_project_connections_project_provider" ON "public"."project_connections" USING "btree" ("project_id", "provider");
...
--
-- Name: blog_post_relations blog_post_relations_post_id_a_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."blog_post_relations"
    ADD CONSTRAINT "blog_post_relations_post_id_a_fkey" FOREIGN KEY ("post_id_a") REFERENCES "public"."blog_posts"("id") ON DELETE CASCADE;

--
-- Name: blog_post_relations blog_post_relations_post_id_b_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."blog_post_relations"
    ADD CONSTRAINT "blog_post_relations_post_id_b_fkey" FOREIGN KEY ("post_id_b") REFERENCES "public"."blog_posts"("id") ON DELETE CASCADE;
...
--
-- Name: blog_post_relations; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: project_bug_reports; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."project_bug_reports" ENABLE ROW LEVEL SECURITY;

--
-- Name: project_connection_handoffs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE "public"."project_connection_handoffs" ENABLE ROW LEVEL SECURITY;

--
-- Name: project_connections; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: acquire_youtube_comment_records starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."acquire_youtube_comment_records" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: acquire_youtube_comments starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."acquire_youtube_comments" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: acquire_youtube_details starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."acquire_youtube_details" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: acquire_youtube_topics starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."acquire_youtube_topics" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: activity_log starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."activity_log" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: app_auth_sessions starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."app_auth_sessions" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: app_auth_users starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."app_auth_users" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: app_project_memberships starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."app_project_memberships" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: app_projects starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."app_projects" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: asset_categories starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."asset_categories" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: assets starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."assets" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: builder_email_templates starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_email_templates" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: builder_extensions starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_extensions" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: builder_extensions_manager starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_extensions_manager" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: builder_forms starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_forms" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: builder_landing_page starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_landing_page" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: builder_modules starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_modules" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: builder_page_templates starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_page_templates" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: builder_themes starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."builder_themes" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: campaign_events starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."campaign_events" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: campaigns starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."campaigns" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: channels starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."channels" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: contact_field_configs starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."contact_field_configs" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: contact_personas starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."contact_personas" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: contact_sources starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."contact_sources" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: contact_statuses starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."contact_statuses" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: contact_types starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."contact_types" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: contacts starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."contacts" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: content_item_assets starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."content_item_assets" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: content_types starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."content_types" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: engage_youtube_comment_agents starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."engage_youtube_comment_agents" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: leads starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."leads" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: memories starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."memories" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_articles starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_articles" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_comments starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_comments" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_content_items starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_content_items" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_content_types starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_content_types" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_ctas starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_ctas" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_descriptions starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_descriptions" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_ebooks starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_ebooks" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_emails starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_emails" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_formats starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_formats" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_hashtags starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_hashtags" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_headlines starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_headlines" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_keywords starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_keywords" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_pitches starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_pitches" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_posts starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_posts" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_prompts starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_prompts" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_reports starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_reports" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_subheadings starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_subheadings" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_subject_lines starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_subject_lines" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_taglines starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_taglines" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_tags starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_tags" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_topics starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_topics" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_transcripts starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_transcripts" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_tweets starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_tweets" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: messaging_white_papers starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."messaging_white_papers" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: promo_lead_field_configs starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."promo_lead_field_configs" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: segment_types starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."segment_types" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: segments starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."segments" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: training_rules_guides starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."training_rules_guides" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: training_settings starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."training_settings" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: training_taxonomy starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."training_taxonomy" FOR SELECT TO "starcaster_readonly" USING (true);

--
-- Name: website_peers starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."website_peers" FOR SELECT TO "starcaster_readonly" USING (true);
...
--
-- Name: youtube_comment_runs starcaster_readonly_select; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "starcaster_readonly_select" ON "public"."youtube_comment_runs" FOR SELECT TO "starcaster_readonly" USING (true);
